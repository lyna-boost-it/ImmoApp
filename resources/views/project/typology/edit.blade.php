    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Modifier une typology</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Modifier une Typology</h2>
            <div class="card">
                <form action="{{ route('Project.typology.update', $type->id) }}" method="post" class="needs-validation"
                    novalidate="">
