...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                <form action="{{ route('Project.project.store', $project->id) }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Delai de la reparation des vices construction<span
                                        class="ob">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label>Garantie de bonne execution est valable pendant<span
                                        class="ob">*</span></label>
