        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Ajouter un projet</div>
            </div>
          </div>
          ...
          <div class="section-body">
             <h2 class="section-title">Ajouter un Projet</h2>
                  <div class="card">
                  <form  action="{{ route('Project.project.store') }}" method="post" class="needs-validation" novalidate="">
                    @csrf
                   ...
                   <div class="form-row">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <input type="number" name="charges" class="form-control" placeholder="DA" required="">
                        <div class="invalid-feedback">
                          ce champ est obligatoire!
                        </div>
                      </div>
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="number" name="additional_charges" class="form-control" placeholder="DA" required="">
                        <div class="invalid-feedback">
                          ce champ est obligatoire!
                        </div>
                      </div>
                  ...
                  <div class="card-header">
                    <h4>Parametres de service Apres Vente</h4>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="number" name="vice_preparations" class="form-control" placeholder="Jours" required="">
                        <div class="invalid-feedback">
                          ce champ est obligatoire!
                        </div>
                      </div>
                      <div class="form-group col-md-6">
                        ...
                        <input type="number" name="guaranty" class="form-control" placeholder="AN(s)" required="">
                        <div class="invalid-feedback">
                          ce champ est obligatoire!
                        </div>
                      </div>
