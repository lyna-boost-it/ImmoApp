    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Ajouter un Prospect</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Ajouter un prospect</h2>
            <div class="card">
                <form action="{{ route('Contact.prospect.store', $contact->id) }}" method="post" class="needs-validation"
                    novalidate="">
                    @csrf
                        ...
                        <div class="form-row">
                         ...
                         <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input value="{{ $contact->ribcb }}"  type="text"  name="rib2" class="form-control"
                                    required="">
                                <div class="invalid-feedback">
                                    ce champ est obligatoire!
                                </div>
